...
<head>
    ...
    <style>
        ...
        /* Google Translate fix - visible වෙන්න + navbar එකේ ලස්සනට පේන්න */
        ...
        /* Elder Homes System button style - ඔයා දුන් button එකම use කරලා තියෙනවා */
        .elder-homes-btn {
        ...
        <div class="d-flex align-items-center justify-content-center flex-wrap gap-4">
            ...
            <div class="text-center flex-grow-1">
                ...
                <div class="d-inline-block">
                    ...
                    <div id="google_translate_element" class="d-inline-block"></div> <!-- Language button මෙතන visible වෙයි -->
                </div>
            </div>
        </div>
    </div>
...
<section id="home" class="hero text-center">
    <div class="news-ticker-hero">
        <div class="ticker-label">
            <i class="fas fa-bullhorn me-1"> නවතම පුවත් </i>
        </div>
    ...
    <div class="container" data-aos="fade-up">
        ...
        <a href="#vision" class="btn btn-light btn-lg px-5 py-3 rounded-pill shadow">වැඩිදුර තොරතුරු <i class="fas fa-arrow-down ms-2"></i></a>
    </div>
</section>
...
<!-- Elder Homes System button - footer ට කලින් centered -->
